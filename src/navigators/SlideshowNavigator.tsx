...
import { View, Button, Item, Input } from 'native-base';
...
const CstsPage = (navigation: NavigationScreenProps) => {
    return <IdPage name="ČSTS IDT" imagePath={require("../../assets/csts.jpeg")} {...navigation} onNext={() => { FirebaseWorker.setInitCompleted(); navigation.navigation.navigate("home") }} saveId={(id: string) => { saveCstsUser(id); FirebaseWorker.setInitCompleted() }} />
}
